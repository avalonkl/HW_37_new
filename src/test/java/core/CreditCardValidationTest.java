...
public class CreditCardValidationTest  {
       ...
       assertThat(CreditCardValidation.type(cc_type, cc_number),
              describedAs("Credit Card Type: " + cc_type + ", should be valid", is(true)));
       }
 
       @Test(dataProvider = "dp", enabled = true, groups = "exp")
       public void exp(String cc_type, String cc_number, String cc_exp, String cc_cvv) {       
	   assertThat(CreditCardValidation.exp(cc_exp),
              describedAs("Credit Card Exp: " + cc_exp + ", should be not expired", is(true)));
       }
 
       @Test(dataProvider = "dp", enabled = true, groups = "cvv")
       public void cvv(String cc_type, String cc_number, String cc_exp, String cc_cvv) {
       assertThat(CreditCardValidation.cvv(cc_type, cc_cvv),
              describedAs("Credit Card CVV: " + cc_cvv + ", should be valid", is(true)));
       }
       ...
       assertThat(CreditCardValidation.luhn(cc_number),
              describedAs("Luhn of: " + cc_number + ", should be valid", is(true)));
       }
}
